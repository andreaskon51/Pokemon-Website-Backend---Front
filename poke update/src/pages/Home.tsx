        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { icon: Star, label: 'Verified Sellers', desc: 'Trusted community members' },
              { icon: Zap, label: 'Instant Payouts', desc: 'Sellers paid within 48h' },
              { icon: Search, label: 'Card Database', desc: 'Auto-fill card details' },
            ].map(item => (
